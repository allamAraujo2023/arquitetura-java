...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  <div class="container-fluid">
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="/calcado/lista">Calcados</a>
	      </li>
	      <li class="nav-item">
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor: ${qtdeVendedor}</span>
	  	...
	  	<span class="badge rounded-pill bg-success">Calcado: ${qtdeCalcado}</span>
	  	<span class="badge rounded-pill bg-danger">Roupa: ${qtdeRoupa}</span>
